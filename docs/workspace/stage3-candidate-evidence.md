...
| 3. Merged commits | Pass | The candidate contains the exact merged remote-main source commits: workspace `38515ecbd55821e724d7fdf9714671357a454068`, backend `44e2402def63bb4d7e2f37d26e5d7f0626b2fd73`, and app `c9b842d958c2d46623c4bf112d251df99d364012`. All three clean copies were rechecked against `origin/main` before packet regeneration and after validation. The Stage 3 evidence-only PR branch is based directly on the workspace commit; backend and app remain clean at their recorded commits. No provider, deployment, preview, production, or merge action was performed. |
