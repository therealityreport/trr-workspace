...
|---|---|---|
| `awsiac` | `command` | IaC best-practice validation and generation hardening. |
| `awsknowledge` | `url` | AWS architecture guidance and service selection tie-breakers. |
| `awslabs-aws-api` | `command` | Validated AWS CLI execution wrapper. |
| `awslabs-aws-docs` | `command` | AWS docs search/read when behavior is uncertain. |
...
| `supabase` | `url` | Supabase DB/schema/functions/storage/log operations. |
