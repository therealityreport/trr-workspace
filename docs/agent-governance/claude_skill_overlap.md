...
| `cloud-architect` | HA/DR prompts, cost/governance/security-by-design prompts where useful in AWS-first wording | multi-cloud defaulting, broad generic cloud-platform ownership | `/Users/thomashulihan/.codex/skills/aws-solution-architect/SKILL.md` and `/Users/thomashulihan/Projects/TRR/skills/senior-devops/SKILL.md` | demoted to generic specialist |
