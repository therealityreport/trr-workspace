...
assert_equals "profiles/local-cloud.env social progress db pool max" "2" "$social_progress_pool_max_local_cloud"
...
assert_equals "profiles/local-cloud.env db pool max" "6" "$db_pool_max_local_cloud"
