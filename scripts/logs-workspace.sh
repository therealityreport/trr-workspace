...
touch "$TRR_APP_LOG" "$TRR_BACKEND_LOG" "$SOCIAL_WORKER_LOG" "$SCREENALYTICS_LOG" "$REMOTE_WORKER_LOG" "$BACKEND_WATCHDOG_EVENTS_LOG"
...
tail -n 200 -f "$TRR_APP_LOG" "$TRR_BACKEND_LOG" "$SOCIAL_WORKER_LOG" "$REMOTE_WORKER_LOG" "$SCREENALYTICS_LOG" "$BACKEND_WATCHDOG_EVENTS_LOG"
