---
name: skillcreator
description: Workspace-local canonical owner for TRR and repo-local skill authoring, dedupe, trigger boundaries, guardrails, and execution contracts.
---
Use this workspace-local skill when creating or refining skills for the TRR workspace or its repos.

## When to use
1. A new TRR/workspace/repo-local skill is needed.
...
4. Keep repo-local skills repo-aware and workspace-local skills cross-repo aware.
