...
2. For repo-deep implementation details, hand off to repo-local owners:
   - `TRR-Backend/skills/senior-backend`
   - `TRR-APP/skills/senior-frontend`
...
## Fallbacks
1. Route backend-heavy execution details to `TRR-Backend/skills/senior-backend`.
2. Route frontend-heavy execution details to `TRR-APP/skills/senior-frontend`.
3. Route release/operational hardening to `/Users/thomashulihan/Projects/TRR/skills/senior-devops/SKILL.md`.
