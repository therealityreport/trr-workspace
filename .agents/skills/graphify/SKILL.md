---
name: graphify
description: "Use only when the user explicitly requests a Graphify build, update, export, or upstream query workflow. Ordinary codebase questions and Plan Architect freshness checks use the @Graphify adapter."
---
